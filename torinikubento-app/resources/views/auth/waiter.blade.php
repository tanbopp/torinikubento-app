...
<div class="h-screen flex flex-col">
    <div class="flex flex-col h-full w-full items-center justify-center">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-neutral-500 text-xl font-medium mb-6">Masuk sebagai Pelayan</p>
        </div>
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            @if(session('success'))
                <div class="mb-4 p-4 bg-green-500/20 border border-green-500/50 rounded-xl">
            ...
            <form action="{{ route('login.submit') }}" method="POST">
                ...
                <input type="hidden" name="expected_role" value="waiter">
                ...
                <div class="flex justify-between items-center w-full mt-8">
                    <button type="button" onclick="window.location.href='{{ route('login') }}'" class="text-orange-500 font-medium flex items-center space-x-1 group">
                    ...
                    <button type="submit" class="bg-orange-500 hover:bg-orange-600 focus:ring-[4px] focus:ring-orange-400/20 text-white font-medium px-8 py-2 rounded-xl transition-colors">
                        Masuk
                    </button>
                </div>
            </form>
