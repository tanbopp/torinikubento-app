{{-- Sidebar --}}
<aside class="fixed top-0 left-0 w-64 h-full bg-neutral-800 border-r border-neutral-700/50 z-40">
	{{-- Logo --}}
	...
	<nav class="p-4 space-y-1">
		{{-- Dashboard --}}
		<a href="/dashboard" class="block px-3 py-2.5 rounded-lg {{ request()->is('dashboard') ? 'bg-orange-600 text-white' : 'text-neutral-300 hover:bg-neutral-700 hover:text-white' }}">
			<span class="font-medium">Dashboard</span>
		</a>

		{{-- Keuangan & Laporan --}}
		<div x-data="{ open: false }">
			<button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-neutral-300 hover:bg-neutral-700 hover:text-white">
		...
		<a href="#" class="block px-3 py-2.5 rounded-lg text-neutral-300 hover:bg-neutral-700 hover:text-white">
	...
	{{-- User Info at Bottom --}}
	<div class="absolute bottom-0 left-0 right-0 p-4 border-t border-neutral-700/50">
		<div x-data="{ userMenuOpen: false }" class="relative">
			...
			<div x-show="userMenuOpen" @click.away="userMenuOpen = false" 
				...
				<div class="py-2">
					...
					<a href="#" class="flex items-center px-4 py-2 text-sm text-red-400 hover:bg-neutral-600 hover:text-red-300">
