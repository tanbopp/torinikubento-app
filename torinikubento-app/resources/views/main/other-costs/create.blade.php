...
@section('page-title', 'Tambah Biaya Lain')
...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white mb-2">Tambah Biaya Lain</h1>
                <p class="text-neutral-400">Buat biaya tambahan baru untuk perhitungan harga pokok produk</p>
            </div>
            <div>
    ...
    {{-- Form --}}
    <form action="{{ route('other-costs.store') }}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="bg-neutral-800 rounded-lg border border-neutral-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-neutral-400">Nama biaya yang mudah dipahami, contoh: "Pajak PPN", "Biaya Layanan"</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span id="currency-symbol" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-neutral-400">%</span>
                                <input type="number" 
                                       name="value" 
                                       value="{{ old('value') }}"
                                       step="0.01"
                            ...
                            @error('value')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                            <p id="value-help" class="mt-1 text-xs text-neutral-400">Masukkan nilai persentase, contoh: 11 untuk 11%</p>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-neutral-800 rounded-lg border border-neutral-700">
                    <div class="p-6 border-b border-neutral-700">
                        <h3 class="text-lg font-semibold text-white">Contoh Penggunaan</h3>
                    </div>
                    <div class="p-6 space-y-4">
                        <div class="bg-neutral-700 rounded-lg p-4">
                            <div class="text-sm font-medium text-white mb-2">Pajak PPN (Persentase)</div>
                            <div class="text-xs text-neutral-400 mb-2">Tipe: Persentase | Nilai: 11%</div>
                            <div class="text-xs text-neutral-300">
                                Jika harga bahan Rp 50.000, maka biaya PPN = Rp 5.500
                            </div>
                        </div>
                        
                        <div class="bg-neutral-700 rounded-lg p-4">
                            <div class="text-sm font-medium text-white mb-2">Biaya Kemasan (Tetap)</div>
                            <div class="text-xs text-neutral-400 mb-2">Tipe: Nominal Tetap | Nilai: Rp 2.000</div>
                            <div class="text-xs text-neutral-300">
                                Setiap produk akan ditambah biaya kemasan Rp 2.000
                            </div>
                        </div>
                    </div>
                </div>
