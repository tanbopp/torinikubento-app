...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white mb-2">🥬 Tambah Bahan Baku</h1>
                <p class="text-neutral-400">Tambah bahan baku baru untuk menu resto Toriniku Bento</p>
            </div>
            <div>
    ...
    <div class="bg-neutral-800 rounded-lg border border-neutral-700">
        <div class="p-6 border-b border-neutral-700">
            <h3 class="text-lg font-semibold text-white">Informasi Bahan Baku</h3>
        </div>
        <div class="p-6">
            <form action="{{ route('ingredients.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="storage_instruction" 
                                          ...
                                          class="w-full bg-neutral-700 border border-neutral-600 rounded-lg px-3 py-2 text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-orange-500 @error('storage_instruction') border-red-500 @enderror">{{ old('storage_instruction') }}</textarea>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-neutral-700">
                    <a href="{{ route('ingredients.index') }}" class="bg-neutral-600 hover:bg-neutral-700 text-white px-6 py-2 rounded-lg transition-colors">
                        Batal
                    </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    minStockInput?.addEventListener('input', function() {
        ...
        if (maxStockInput && (!maxStockInput.value || parseFloat(maxStockInput.value) < minValue)) {
